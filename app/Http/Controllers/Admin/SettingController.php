...
class SettingController extends Controller
{
    ...
    public function integrations(Request $request){
        ...
        if(count($input)){
            ...
            $user->save();
            return view('admin.settings.integration', ['title' => 'Integration', 'xero'=>'Xero is successfully connected!']);
        }

        return view('admin.settings.integration', ['title' => 'Integration', 'xero'=>'']);
    }
