  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Branches List</h3>
    ...
    <div class="card-body">
      ...
      <div>
	      <form action="{{route('admin.delete-selected-branches')}}" method="post" id="client_form">
	      <input type="hidden" name="_token" value="{{ csrf_token() }}">
      <!--begin: Datatable-->
      <table class="table table-bordered table-hover table-checkable" id="branches" style="margin-top: 13px !important">
        <thead>
        <tr>
	        <th>
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				  <div class="modal-header">
					  ...
					  <h4 class="modal-title" id="myModalLabel">Branches Detail</h4> </div>
      ...
      function del(id){
          ...
          icon: "warning",
              ...
              if (result.value) {
                  Swal.fire(
                      "Deleted!",
                      "Your Specified Branch has been deleted.",
                      "success"
                  );
                  var APP_URL = {!! json_encode(url('/')) !!}
                  window.location.href = APP_URL+"/admin/branches/delete/"+id;
              }
          });
      }
      function del_selected(){
          Swal.fire({
              ...
              if (result.value) {
                  Swal.fire(
                      "Deleted!",
                      "Your Branches has been deleted.",
                      "success"
                  );
                  $("#client_form").submit();
              }
