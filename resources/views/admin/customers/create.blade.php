                ...
                <div class="card card-custom card-sticky" id="kt_page_sticky_card">
                    <div class="card-header" style="">
                        <div class="card-title">
                            <h3 class="card-label">Customer Add Form
                                <i class="mr-2"></i>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="btn-group">
                                <a href="{{ route('customers.store') }}"
                                    onclick="event.preventDefault(); document.getElementById('client_add_form').submit();"
                    ...
                    <div class="card-body">
                        ...
                        <!--begin::Form-->
                        {{ Form::open(['route' => 'customers.store','class' => 'form','id' => 'client_add_form','enctype' => 'multipart/form-data']) }}
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-xl-8">
                                <div class="my-5">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-form-label col-lg-3 col-sm-12">Pricing Plan</label>
                                        <div class=" col-5">
                                        ...
                                        <div class=" col-4">
                                            <p style="font-size: 13px;">If plan does not exist, <a
                                                    href="{{ route('pricing.create') }}">Create a Plan</a> </p>
                                        </div>
                                    </div>
