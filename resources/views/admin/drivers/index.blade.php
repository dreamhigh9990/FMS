  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Drivers List</h3>
      ...
      <div class="card-toolbar">
        ...
        <!--begin::Button-->
        <a href="{{ route('driver.create') }}" class="btn btn-primary font-weight-bolder">
    ...
    <div class="card-body">
      ...
      <div>
	      <form action="{{route('admin.delete-selected-drivers')}}" method="post" id="client_form">
	      <input type="hidden" name="_token" value="{{ csrf_token() }}">
      <!--begin: Datatable-->
      <table class="table table-bordered table-hover table-checkable" id="manifest" style="margin-top: 13px !important">
        <thead>
        <tr>
	        <th>
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				  <div class="modal-header">
					  ...
					  <h4 class="modal-title" id="myModalLabel">Driver Detail</h4> </div>
...
@section('scripts')
  ...
  <script>
      ...
      function viewInfo(id) {
          ...
          $.post("{{ route('get_driver') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
      ...
      function del(id){
          ...
          icon: "warning",
              ...
              if (result.value) {
                  ...
                  window.location.href = APP_URL+"/admin/driver/delete/"+id;
              }
          });
      }
