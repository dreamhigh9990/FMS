  ...
  <div class="card card-custom">
    <div class="card-header">
      <div class="card-title">
        ...
        <h3 class="card-label">Employees List</h3>
    ...
    <div class="card-body">
      ...
      <div>
	      <form action="{{route('admin.delete-selected-employee')}}" method="post" id="client_form">
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				  <div class="modal-header">
					  ...
					  <h4 class="modal-title" id="myModalLabel">Employee Detail</h4> </div>
...
@section('scripts')
  ...
  <script>
      ...
      function del(id){
          ...
          icon: "warning",
              ...
              if (result.value) {
                  Swal.fire(
                      "Deleted!",
                      "Your Specified Employee has been deleted.",
                      "success"
                  );
                  var APP_URL = {!! json_encode(url('/')) !!}
                  window.location.href = APP_URL+"/admin/employee/delete/"+id;
              }
          });
      }
      function viewInfo(id) {
          ...
          $.get("{{ route('admin.getEmployee') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
