...
@section('content')
  ...
  <div class="card card-custom">
    ...
    <div class="card-body">
      ...
      <div>
	      <form action="{{route('admin.delete-selected-items')}}" method="post" id="client_form">
	      <input type="hidden" name="_token" value="{{ csrf_token() }}">
      <!--begin: Datatable-->
      <table class="table table-bordered table-hover table-checkable" id="items" style="margin-top: 13px !important">
        <thead>
        <tr>
	        <th>
		  ...
		  <div class="modal-dialog modal-dialog-centered" role="document">
			  <div class="modal-content">
				  <div class="modal-header">
					  ...
					  <h4 class="modal-title" id="myModalLabel">Items Detail</h4> </div>
...
@section('scripts')
  ...
  <script>
      ...
      function viewInfo(id) {
          ...
          $.post("{{ route('admin.getItem') }}", {_token: CSRF_TOKEN, id: id}).done(function (response) {
      ...
      function del(id){
          ...
          icon: "warning",
              ...
              if (result.value) {
                  Swal.fire(
                      "Deleted!",
                      "Your Specified Item has been deleted.",
                      "success"
                  );
                  var APP_URL = {!! json_encode(url('/')) !!}
                  window.location.href = APP_URL+"/admin/items/delete/"+id;
              }
          });
      }
