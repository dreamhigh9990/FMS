...
<div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto" id="kt_brand">
        ...
        <a href="{{ route('admin.dashboard') }}" class="brand-logo">
            <img style="width: 200px;height: 80px; padding: 15px" alt="Logo" src="{{ asset($logo) }}" />
        </a>
    ...
    echo 'menu-item-active';
                ...
                <li class="menu-section">
                    <h4 class="menu-text">Freight</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'jobs') {
                                    echo 'menu-item-active';
                                } ?>" aria-haspopup="true">
                                    <a href="{{ route('jobs.create') }}" class="menu-link">
                                        <span class="svg-icon menu-icon">
                                            ...
                                            <span class="svg-icon menu-icon">
                                                <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Files/File-plus.svg--><svg
                                        ...
                                        <span class="menu-text">New Job</span>
                                    </a>
                                </li>


                                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'freight') {
                                    echo 'menu-item-active';
                                } ?>" aria-haspopup="true">
                                    <a href="{{ route('freight-index') }}" class="menu-link">
                                        <span class="svg-icon menu-icon">
                                        ...
                                        <span class="menu-text">Manage Freight</span>
                                    </a>
                                </li>



                                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'manifest') {
                                    echo 'menu-item-active';
                                } ?>" aria-haspopup="true">
                                    <a href="{{ route('manifest.index') }}" class="menu-link">
                                        <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Library.svg-->
                                        <span class="svg-icon menu-icon">
                                            <!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Shopping/Loader.svg--><svg
                                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24" />
                                        ...
                                        <span class="menu-text">Manage Manifest</span>
                                    </a>
                                </li>


                                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'create-job-status') {
                                    echo 'menu-item-active';
                                } ?>" aria-haspopup="true">
                                    <a href="{{ route('create_job_status') }}" class="menu-link">
                                        <span class="svg-icon menu-icon">
                                        ...
                                        <span class="menu-text">Update Job Status</span>
                                    </a>
                                </li>

                                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'pallet') {
                                    echo 'menu-item-active';
                                } ?>" aria-haspopup="true">
                                    <a href="{{ route('pallet.index') }}" class="menu-link">
                                        <span class="svg-icon menu-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<rect x="0" y="0" width="24" height="24"></rect>
													<rect fill="#fff" x="4" y="4" width="7" height="7" rx="1.5"></rect>
													<path d="M5.5,13 L9.5,13 C10.3284271,13 11,13.6715729 11,14.5 L11,18.5 C11,19.3284271 10.3284271,20 9.5,20 L5.5,20 C4.67157288,20 4,19.3284271 4,18.5 L4,14.5 C4,13.6715729 4.67157288,13 5.5,13 Z M14.5,4 L18.5,4 C19.3284271,4 20,4.67157288 20,5.5 L20,9.5 C20,10.3284271 19.3284271,11 18.5,11 L14.5,11 C13.6715729,11 13,10.3284271 13,9.5 L13,5.5 C13,4.67157288 13.6715729,4 14.5,4 Z M14.5,13 L18.5,13 C19.3284271,13 20,13.6715729 20,14.5 L20,18.5 C20,19.3284271 19.3284271,20 18.5,20 L14.5,20 C13.6715729,20 13,19.3284271 13,18.5 L13,14.5 C13,13.6715729 13.6715729,13 14.5,13 Z" fill="#fff" opacity="1"></path>
												</g>
											</svg>
                                            ...
                                            xml:space="preserve">    <metadata> Svg Vector Icons : http://www.onlinewebfonts.com/icon </metadata>
                                                <g >
                                                    <path fill="#fff"  d="M442,399.8c0,33-26.7,59.7-59.7,59.7H69.7c-33,0-59.7-26.7-59.7-59.7V87.2c0-33,26.7-59.7,59.7-59.7h312.6c33,0,59.7,26.7,59.7,59.7V399.8z"/>
                                                    <path fill="#fff" d="M990,399.8c0,33-26.7,59.7-59.7,59.7H617.7c-33,0-59.7-26.7-59.7-59.7V87.2c0-33,26.7-59.7,59.7-59.7h312.6c33,0,59.7,26.7,59.7,59.7L990,399.8L990,399.8z"/>
                                                    <path fill="#fff" d="M445.6,912.8c0,33-26.7,59.7-59.7,59.7H73.3c-33,0-59.7-26.7-59.7-59.7V600.2c0-33,26.7-59.7,59.7-59.7h312.6c33,0,59.7,26.7,59.7,59.7V912.8z"/>
                                                    <path fill="#000" opacity="0.3" d="M990,912.8c0,33-26.7,59.7-59.7,59.7H617.7c-33,0-59.7-26.7-59.7-59.7V600.2c0-33,26.7-59.7,59.7-59.7h312.6c33,0,59.7,26.7,59.7,59.7L990,912.8L990,912.8z"/>
                                                </g>
                                            </svg> --}}
                                        </span>
                                        <span class="menu-text">Pallet Control</span>
                                    </a>
                                </li>
                <hr/>
                <li class="menu-section">
                    ...
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                ...
                                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'customers') {
                                    echo 'menu-item-active';
                                } ?>" aria-haspopup="true">
                                ...
                                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'pricing') {
                                    echo 'menu-item-active';
                                } ?>" aria-haspopup="true">
                                    <a href="{{ route('pricing.index') }}" class="menu-link">
                                        ...
                                        <span class="menu-text">Manage Pricing</span>
                                    </a>
                                </li>
                <hr/>
                <li class="menu-section">
                    ...
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                                ...
                                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'billing') {
                                    echo 'menu-item-active';
                                } ?>" aria-haspopup="true">
                                    <a href="{{ route('admin.dashboard') }}" class="menu-link">
                                        <span class="svg-icon menu-icon">
                ...
                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'items') {
                    echo 'menu-item-active';
                } ?>" aria-haspopup="true">
                ...
                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'branches') {
                    echo 'menu-item-active';
                } ?>" aria-haspopup="true">
                ...
                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'jobstatus') {
                    echo 'menu-item-active';
                } ?>" aria-haspopup="true">
                ...
                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'dirver') {
                    echo 'menu-item-active';
                } ?>" aria-haspopup="true">
                ...
                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'employee') {
                    echo 'menu-item-active';
                } ?>" aria-haspopup="true">
                ...
                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'user') {
                    echo 'menu-item-active';
                } ?>" aria-haspopup="true">
                ...
                <li style="margin-bottom: 8px;" class="menu-item <?php if (Request::segment(1) == 'admin' && Request::segment(2) == 'integration') {
                    echo 'menu-item-active';
                } ?>" aria-haspopup="true">
                    <a href="{{ route('setting.integration') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                    viewBox="0 0 496.158 496.158" style="enable-background:new 0 0 496.158 496.158;" xml:space="preserve">
                                <path fill="#000000" fill-rule="nonzero" opacity="0.3" d="M0,248.085C0,111.064,111.07,0.003,248.076,0.003c137.012,0,248.082,111.061,248.082,248.082
