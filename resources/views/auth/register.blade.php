                ...
                <div class="login-form login-signin">
                    ...
                    {{-- <form class="form" method="POST" action="{{ route('register') }}" novalidate="novalidate">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                class="@error('name') is-invalid @enderror form-control form-control-solid h-auto py-6 px-6 rounded-lg"
                                type="text" name="name" value="{{ old('name') }}" autocomplete="off" />
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                required autocomplete="new-password" type="password" name="password_confirmation" />
                            @error('password')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong> </span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <div class="d-flex justify-content-center mt-n5">
                                <div class="ui segment"><button type="submit"
                                        class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">{{ __('Register') }}</button></div>
                            </div>
                        </div>

                        <div class="form-group row float-right">
                            <a href="{{ url('/login') }}" class="text-sm text-gray-700 underline right">Back to Login</a>
                        </div>
                    </form> --}}
                    <!--end::Form-->
                </div>
